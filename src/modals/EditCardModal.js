...
const EditCardModal = ({ card, list, setShowModal }) => {
  ...
  let comments = {
    author: {
      email: 'haidangluu94@gmail.com',
      full_name: 'luu dang',
      profile_pic: 'http://localhost:8000/media/profile_pics/3_3.png',
      username: 'haidang124',
    },

    body: 'hello',
    created_at: '2021-04-08T19:54:08.010313Z',
    id: 1,
  };
  return (
    <div className="edit-modal">
      ...
      <div className="edit-modal__cols">
        <div className="edit-modal__left">
          ...
          <CommentForm
            card={card}
            style={(comments || []).length === 0 ? { marginBottom: 0 } : null}
