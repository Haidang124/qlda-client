...
const ModalDetailTask: React.FC<any> = (props: any) => {
  ...
  const CalcPercent = () => {
    let totalTask =
      props.dataUser.taskInProgress.length +
      props.dataUser.taskPlanned.length +
      props.dataUser.taskComplete.length;
    return totalTask === 0
      ? NaN
      : Math.floor(
          (props.dataUser.taskComplete.length / totalTask) * 100 + 0.05,
        );
  };
            ...
            <div className="col-11">
              <div className="row">
                <h3 className="text-warning">
                  Planned ({props.dataUser.taskPlanned.length})
                </h3>
              </div>
                      ...
                      <div className="card-body">
                        ...
                        <p
                          ...
                          <span style={{ color: '#007BFF' }}>
                            {props.data[value.authorId].username}
                          </span>
                        </p>
                        <p
                          style={{
            ...
            <div className="col-11">
              <div className="row">
                <h3 className="text-primary">
                  In Progress ({props.dataUser.taskInProgress.length})
                </h3>
              </div>
              <div className="row" style={{ width: '100%' }}>
            ...
            <div className="col-11">
              <div className="row">
                <h3 className="text-success">
                  Completed ({props.dataUser.taskComplete.length})
                </h3>
              </div>
              <div className="row" style={{ width: '100%' }}>
            ...
            <div className="col-11">
              <div className="row">
                <h3 className="text-danger">
                  Over deadline ({props.dataUser.taskOverDeadline.length})
                </h3>
              </div>
              <div className="row" style={{ width: '100%' }}>
