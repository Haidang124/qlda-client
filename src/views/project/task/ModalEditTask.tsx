...
const ModalEditTask: React.FC<any> = (props: any) => {
  //props: funcQuit(), funcEdit(),
              ...
              <div className="row" id="user">
                <div className="col d-flex just-content-center">
                  <div className="col-11">
                    {(check ? listAssignment : props.data.assignment).map(
                      (value, index) => {
                        return (
                          <div
          ...
          <div className="row">
            ...
            <div className="col lg-6">
              <Button
                ...
                onClick={(e) => {
                  let arr = check
                    ? [...getListUserId(listAssignment)]
                    : [...getListUserId(props.data.assignment)];
                  let data = {
                    id: props.data.id,
