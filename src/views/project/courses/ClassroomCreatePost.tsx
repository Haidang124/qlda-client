...
// import { defaultImage, getUrlAvatar } from '../../../../utils/image';
// import { shallowEqual, useSelector } from 'react-redux';
// import { faTimes } from '@fortawesome/free-solid-svg-icons';

const ClassroomCreatePost: React.FC = () => {
  return <></>;
  // const { user } = useSelector(
  //   (state: any) => ({
  //     user: state.appConfig.config?.user,
  //   }),
  //   shallowEqual,
  // );
  ...
  // const { classroom, createPost } = useClassroomContext();
  ...
  // return (
  //   <div className="new-status-input card">
  //     <div className="d-flex">
  //       <img
  //         className="user-avatar mt-2"
  //         src={getUrlAvatar({ id: user.id })}
  //         alt="avatar"
  //         width={50}
  //         height={50}
  ...
  //           ref={ref}
  //           value={value}
  //           placeholder={`Thêm thông báo, dặn dò cho lớp học ${classroom?.name} ...`}
  ...
  //                 <img
  //                   className="mr-2"
  //                   src="/images/classroom/add-meeting.svg"
  //                   alt=""
  //                 />
  //                 Thêm phòng học
  //               </Button>
...
export default ClassroomCreatePost;
