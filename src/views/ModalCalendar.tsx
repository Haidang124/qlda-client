...
const ModalCalendar: React.FC<any> = (props: any) => {    //props: funcQuit(), show, date
  const formatDate = () => {
    ...
    return (date.length<2?"0"+date:date)+"/"+(month.length<2?"0"+month:month)+"/"+year;
  }
    ...
    <>
      <Modal
        ...
        <Modal.Body>
            ...
            <div className="row d-flex justify-content-center mt-5 mb-2" style={{height:"500px"}}>
                <div className="col-11">
                  <div className="row">
                    <h3 className="text-warning">Task chưa hoàn thành:</h3>
                            ...
                            <>
                              <div className="card" style={{width: "23%", padding: "10px", border: "2px solid #FFC107", 
                                  ...
                                  <div className="card-body">
                                      <h4 className="card-title text-priamry">{value.taskname}</h4>
                                      <p style={{fontWeight: "bold", fontSize:"11px", margin: "0px"}}>
                                          <span >Project name: </span>
                                          <span style={{color:"#007BFF"}}>{value.projectName}</span>
                                      </p>
                                  </div>
                              </div>
                            </>
                  ...
                  <div className="row mt-3">
                    <h3 className="text-success">Task đã hoàn thành:</h3>
                    <div className="row" style={{width: "100%"}}>
                  ...
                  <div className="row mt-3">
                    <h3 className="text-danger">Task Over deadline:</h3>
                    <div className="row" style={{width: "100%"}}>
                        {listTaskOverdeadline().map((value, i) => {
                          return (
                            <>
                              <div className="card" style={{width: "23%", padding: "10px", border: "2px solid #e22e2f", 
                                                        marginLeft:"2%", marginBottom:"2%"}}>
                                  <div className="card-body">
                                      <h4 className="card-title text-priamry">{value.taskname}</h4>
                                      <p style={{fontWeight: "bold", fontSize:"11px", margin: "0px"}}>
